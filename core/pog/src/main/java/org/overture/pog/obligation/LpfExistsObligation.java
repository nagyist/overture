...
public class LpfExistsObligation extends LpfProofObligation
{

	private static final long serialVersionUID = 1L;

	public LpfExistsObligation(AExistsExp node, List<PExp> definePredicates,
	...
	public LpfExistsObligation(AExists1Exp node, List<PExp> definePredicates,
