...
public class LpfOrObligation extends LpfProofObligation
{
	 ...
	 * @param lExp the left side of the 'or' expression
	 * @param rExp the right side of the 'or' expression
	 ...
	 */
	public LpfOrObligation(PExp andExp, PExp lExp, PExp rExp, List<PExp> definedPredicates, IPOContextStack ctxt)
	{
		...
		PExp or1_exp = AstExpressionFactory.newAOrBooleanBinaryExp(ltrue_exp, rtue_exp);
